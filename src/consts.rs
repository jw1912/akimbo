...
// eval values
pub const MATERIAL: [S; 5] = [S(83, 143), S(315, 267), S(335, 279), S(433, 488), S(915, 933)];
pub const PAWN_PST: [S; 24] = [
    S( 62, 125), S( 89, 115), S( 87,  93), S( 88,  80),
    S(-30,  47), S( -3,  44), S( 16,  24), S( 31,  18),
    S(-37, -13), S(-16, -19), S(-23, -29), S( -9, -40),
    S(-35, -35), S(-20, -33), S(-17, -46), S(-10, -49),
    S(-26, -43), S( -4, -41), S(-20, -47), S(-15, -43),
    S(-32, -41), S(-10, -34), S(-22, -36), S(-29, -31),
];
pub const MOBILITY_KNIGHT: [S; 9] = [S(-39, -77), S(-11, -54), S(0, -35), S(6, -19), S(14, -7), S(18, 10), S(22, 14), S(23, 22), S(38, 10)];
pub const MOBILITY_BISHOP: [S; 14] = [S(-21, -71), S(-7, -59), S(1, -34), S(7, -19), S(12, -6), S(14, 3), S(18, 11), S(19, 13), S(23, 19), S(24, 19), S(40, 19), S(45, 20), S(54, 22), S(50, 22)];
pub const MOBILITY_ROOK: [S; 15] = [S(-32, -84), S(-15, -59), S(-19, -33), S(-18, -16), S(-13, -8), S(-13, 2), S(-9, 4), S(-6, 10), S(1, 16), S(11, 17), S(16, 20), S(20, 22), S(22, 25), S(32, 21), S(27, 25)];
