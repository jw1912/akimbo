...
// eval values
pub const MATERIAL: [S; 5] = [S(89, 147), S(291, 236), S(320, 253), S(409, 469), S(930, 939)];
pub const PAWN_PST: [S; 24] = [
    S( 74, 123), S( 98, 113), S( 89,  90), S( 94,  75),
    S(-31,  43), S(  2,  37), S( 25,  14), S( 39,   7),
    S(-36, -17), S( -9, -25), S(-20, -35), S( -1, -47),
    S(-37, -38), S(-16, -37), S(-16, -50), S( -5, -53),
